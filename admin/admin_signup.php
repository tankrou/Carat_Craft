...
if(isset($_POST["signup"])){
    ...
    $getRecord = $connection->prepare('SELECT * FROM account WHERE account_username = ?  OR account_email = ?');
    

    $getRecord->execute([$username,$email]);
                ...
                <form id="signup_form" action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input 
                               ...
                               id="username"   
                               name="username"
                               placeholder="Put your admin name here" required>
                    </div> 
                    ...
                    <div class="text-center mt-2">
                        <p class="text-danger" style="font-size:20px;"><?php echo $message; ?></p>
                    </div>
