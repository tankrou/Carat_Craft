...
if (!empty($_FILES["profile_photo"]["name"])) {
	...
	$new_name      = $target_folder . "admin_" . time() . "." . $file_ext;
...
<form method="POST" enctype="multipart/form-data">
	...
	<button type="submit" name="upload" class="btn search-btn">Save</button>
	 <a class="btn search-btn" style="width:200px;" href="../user/manage_account.php?id=<?= $account_id ?>">Manage Account</a>
</form>
</div>
</div>
