...
<div class="container mt-4">
      ...
      <div class="poster" style="padding:20px;">
         <h1 style="text-align: center; padding:8px; padding-bottom:20px;font-weight:bold;  color: #ffffff; -webkit-text-stroke:0.8px black; ">🎧⋆˙♪⋆✮ OTHER ✮⋆♪˙⋆🎧</h1>
 
         <div class="row">
           <div class="col-sm-12">
            <div class="row">
                <?php foreach ($posts as $post): ?>
              <?php if ($post['categories_id'] == 4):  ?>
