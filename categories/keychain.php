...
<div class="container mt-4">
    ...
    <div class="keychain" style="padding:20px;">
         <h1 style="text-align: center; padding:8px; padding-bottom:20px;font-weight:bold;  color: #ffffff; -webkit-text-stroke:0.8px black; ">🎧⋆˙♪⋆✮ KEYCHAIN ✮⋆♪˙⋆🎧</h1>
     <div class="row">
