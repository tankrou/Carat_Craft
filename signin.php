...
if(isset($_POST["signin"])){
   ...
   $getRecord = $connection->prepare('
    SELECT * FROM account 
    WHERE (account_username = ? OR account_email = ?) 
    AND account_role = "DES"
    ');
    
    $getRecord->execute([$user_input, $user_input]);
    ...
    if($getRecordResult && password_verify($password,$getRecordResult["account_password"])){
        ...
        $_SESSION["account_role"] = $getRecordResult["account_role"];
       //go to member page
                ...
                <form id="signin_form" action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input 
                               ...
                               id="username"   
                               name="username"
                               placeholder="Put your username or email here"/>
                    </div> 
