...
<div style="height: 30px;"></div>    
        ...
        <div class="w3-content w3-section" style="max-width:300%; align-item:center ;">
          <img class="mySlides" src="../image/Mainpage_photo.jpg" style="width:100%">
          <img class="mySlides" src="../image/Mainpage_photo2.jpg" style="width:100%">
          <img class="mySlides" src="../image/Mainpage_photo3.jpg" style="width:100%">
        </div>
    
    <div class="albums-title" style="color: #ffffff;padding-top:50px;-webkit-text-stroke:0.5px black">🎧⋆˙♪⋆.✮ EVENT ✮⋆♪˙⋆˙🎧</div>
        
        <div class="container">
          <?php while($event = $getRecord->fetch(PDO::FETCH_ASSOC)) { ?>
